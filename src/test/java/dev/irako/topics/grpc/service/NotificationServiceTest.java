...
class NotificationServiceTest {
	...
	void generateNotifications_nullUserId_throwsException() {
		assertThrows(IllegalArgumentException.class, () -> {
			NotificationService.generateNotifications(null, List.of("news"), 1).collect(Collectors.toList());
		});
	}
	...
	void generateNotifications_emptyTopics_throwsException() {
		assertThrows(IllegalArgumentException.class, () -> {
			NotificationService.generateNotifications("user123", List.of(), 1).collect(Collectors.toList());
		});
	}
	...
	void generateNotifications_negativeCount_throwsException() {
		assertThrows(IllegalArgumentException.class, () -> {
			NotificationService.generateNotifications("user123", List.of("news"), -1).collect(Collectors.toList());
		});
	}
}
