...
public final class NotificationService {
    ...
    /**
     * Generates a stream of notifications for the given user and topics.
     * This simulates notifications that would be sent over time.
     * 
     * @param userId the user ID to generate notifications for
     * @param topics the topics to generate notifications for
     * @param count the number of notifications to generate
     * @return stream of notification DTOs
     */
    public static Stream<NotificationDto> generateNotifications(
            String userId,
            List<String> topics,
            int count
    ) {
