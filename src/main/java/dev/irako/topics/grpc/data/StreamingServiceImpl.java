 ...
 * Handles I/O and delegates business logic to service layer.
 */
public final class StreamingServiceImpl extends StreamingServiceGrpc.StreamingServiceImplBase {
    ...
    public void subscribeToNotifications(
        ...
        try {
            ...
            var notificationStream = NotificationService.generateNotifications(
                    request.getUserId(),
                    topics,
                    10 // Generate 10 notifications as example
            );
    ...
    public StreamObserver<SensorReading> uploadSensorData(StreamObserver<AggregateResponse> responseObserver) {
        ...
        return new StreamObserver<SensorReading>() {
            ...
            public void onNext(SensorReading reading) {
                logger.debug("Received sensor reading: sensorId={}, value={}", 
            ...
            public void onCompleted() {
                try {
                    ...
                    SensorAggregateDto aggregate = SensorAggregationService.aggregateReadings(
                            readings,
                            startTime.get(),
                            endTime
                    );
                    ...
                    logger.info("Sent aggregate response: totalReadings={}, avg={}", 
                            aggregate.totalReadings(), aggregate.averageValue());
                } catch (Exception e) {
